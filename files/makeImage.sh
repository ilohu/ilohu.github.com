#!/bin/bash
# Original by sunkid on http://www.insanelymac.com/forum/index.php?showtopic=184462
#
# Slightly modified by Mike Staszel <mikestaszel@gmail.com>
#
...
usage ()
{
     ...
     echo "	Create a disk image with a max storage size of <size> gigabytes and copy it"
...
echo -n "Ignore errors any errors as it should work anyway ..."
hdiutil create -size ${SIZE}G -fs HFS+J -type SPARSEBUNDLE \
	-volname 'Time Machine' "${NAME}.sparsebundle" >> /dev/null 2>&1
